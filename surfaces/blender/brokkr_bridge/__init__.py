...
class BROKKR_PT_status(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        object_box.prop(prefs, "sync_session_id")
        object_box.prop(prefs, "sync_display_name")
        object_box.prop(prefs, "unity_object_id")
        object_box.prop(prefs, "unity_object_path")
        object_box.prop(prefs, "sync_transform")
        object_box.prop(prefs, "sync_parent")
        object_box.prop(prefs, "sync_material")
        object_box.prop(prefs, "sync_visibility")
        object_box.prop(prefs, "sync_custom_properties")
        property_column = object_box.column()
        property_column.enabled = prefs.sync_custom_properties
        property_column.prop(prefs, "unity_custom_property_component_type")
        property_column.prop(prefs, "unity_custom_property_path")
        property_column.prop(prefs, "blender_custom_property_path")
        object_box.operator("brokkr.publish_object_sync", icon="LINKED")

        timeline_box = layout.box()
        timeline_box.label(text="Timeline / Cinemachine")
        timeline_box.prop(prefs, "unity_timeline_object_id")
        timeline_box.prop(prefs, "unity_cinemachine_object_id")
        timeline_box.prop(prefs, "blender_action_name")
        timeline_box.prop(prefs, "sync_timeline_frame")
        timeline_box.prop(prefs, "sync_cinemachine_camera")
        timeline_box.operator("brokkr.publish_timeline_sync", icon="TIME")
